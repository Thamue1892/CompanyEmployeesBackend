...
namespace CompanyEmployees.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            ...
            {
                s.SwaggerDoc("v1", new OpenApiInfo { Title = "Thaymes API", Version = "v1",Description = "CompanyEmployees API by Thaymes",TermsOfService = new Uri("https://thami.co.za"),Contact = new OpenApiContact
                {
                    Name = "Thamsanqa Mpofu",
                    Email = "tmpofu@thami.co.za",
                    Url = new Uri("https://thami.co.za"),
                },
                ...
                s.SwaggerDoc("v2", new OpenApiInfo { Title = "Thaymes API", Version = "v2" });
